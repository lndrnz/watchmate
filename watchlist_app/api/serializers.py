...
class WatchListSerializer(serializers.ModelSerializer):
    reviews = ReviewSerializer(many=True, read_only=True) #read_only means you cant add a review through this serializer
...
class StreamingPlatformSerializer(serializers.ModelSerializer): #use serializers.HyperlinkedModelSerializer for urls
